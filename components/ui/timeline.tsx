...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="font-sans w-full px-4 md:px-10" ref={containerRef}>
      <div ref={ref} className="relative w-full pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start w-full pt-10 md:gap-10"
          >
            {/* Coluna esquerda */}
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start w-1/4 md:w-1/5">
            ...
            <div className="relative pl-12 md:pl-4 w-3/4 md:w-4/5">
